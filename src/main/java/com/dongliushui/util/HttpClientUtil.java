...
//            System.out.println("响应内容: " + responseContent);
    ...
    public static String sendPostRequest(String reqURL, String jsonString, String encodeCharset, String decodeCharset)  {
        String responseContent = null;
        HttpClient httpClient = new DefaultHttpClient();
...
//            br.close();
    ...
    public static String sendHttpsGetRequest(String reqURL,String decodeCharset){
        long responseLength = 0;       //响应长度
        String responseContent = null; //响应内容
